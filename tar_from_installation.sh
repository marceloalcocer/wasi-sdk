...
# installation.
tar czf $OUTDIR/libclang_rt.builtins-wasm32-wasi-$VERSION\-$MACHINE.tar.gz -C compiler-rt lib/wasi
tar czf $OUTDIR/wasi-sysroot-$VERSION\-$MACHINE.tar.gz -C wasi-sdk-$VERSION/share wasi-sysroot
